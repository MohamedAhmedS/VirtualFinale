...
package com.example.virtualmeetingapp.SpaceTabLayout.SpaceTabLayoutUserType;
...
import com.example.virtualmeetingapp.SpaceTabLayout.PagerAdapter;
...
public class SpaceTabLayout1 extends RelativeLayout {
    ...
    private Drawable defaultTabOneButtonIcon,brown1;
    private Drawable defaultTabTwoButtonIcon, brown2;
    private Drawable defaultTabThreeButtonIcon, brown3;
    private Drawable defaultTabFourButtonIcon, brown4;
    private Drawable defaultTabFiveButtonIcon, brown5;
    ...
    public SpaceTabLayout1(Context context) {
        super(context);
        init();
    }

    public SpaceTabLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        initArrts(attrs);
    }

    public SpaceTabLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_five);
        ...
        brown1 = getContext().getResources().getDrawable(R.drawable.ic_tab_onebrown);
        brown2 = getContext().getResources().getDrawable(R.drawable.ic_tab_twobrown);
        brown3 = getContext().getResources().getDrawable(R.drawable.ic_tab_threebrown);
//        brown4 = getContext().getResources().getDrawable(R.drawable.ic_tab_fourbrown);
//        brown5 = getContext().getResources().getDrawable(R.drawable.ic_tab_fivebrown);
    ...
    private void initArrts(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SpaceTabLayout1);
        for (int i = 0; i < a.getIndexCount(); ++i) {
            int attr = a.getIndex(i);
            if (attr == R.styleable.SpaceTabLayout1_number_of_tabs) {
                numberOfTabs = a.getInt(attr, 3);
                if (numberOfTabs == 0) {
                    numberOfTabs = 3;
                    iconOnly = false;
                }
            } else if (attr == R.styleable.SpaceTabLayout1_starting_position) {
...
//
//            }
            else if (attr == R.styleable.SpaceTabLayout1_text_one) {
                text_one = a.getString(attr);

            } else if (attr == R.styleable.SpaceTabLayout1_text_two) {
                text_two = a.getString(attr);

            } else if (attr == R.styleable.SpaceTabLayout1_text_three) {
