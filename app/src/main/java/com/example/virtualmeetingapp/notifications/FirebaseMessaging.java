...
//    private void setupPostNotificationChannel(MNotificationManager notificationManager) {
//        CharSequence channelName = "New Notification";
//        String channelDescription = "Device to device post notification";
//
//        NotificationChannel adminChannel = new NotificationChannel(ADMIN_CHANNEL_ID, channelName, MNotificationManager.IMPORTANCE_HIGH);
...
//    }
    ...
    private void sendOAndAboveNotification(RemoteMessage remoteMessage) {
        ...
        assert icon != null;
        NotificationCompat.Builder builder = notification1.getONotifications(title, body, pIntent, defSoundUri, Integer.parseInt(icon));
